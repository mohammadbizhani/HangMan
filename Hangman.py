...
def main():
    # saying wellcome 
    print("Hello, This is hangman game created by MohammadBizhani...")
    time.sleep(1)

    # ask to give the turns
    a = int(input("Choose your number of chance: "))
    turns = a
    time.sleep(1)

    # starting the game
    print ("Alright... Let's start guessing ...")
    time.sleep(0.5)

    # a long string of words that we split it to gain the word and choose from one of them randomly
    ...
    # characters that we guess set here
    guesses = ''

    # list of the characters there were wrong
    wrong_guesses = []
    ...
    while turns > 0:         
        ...
        while True:
            ...
            if guess.isalpha() and len(guess) == 1:
                ...
                print("Invalid char. Please input Valid char.")
                continue
        ...
        if guess not in word:  
            ...
            if turns != 0:
                print (f"That was wrong...\nlist of your wrong guesses: {wrong_guesses}")
